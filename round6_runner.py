...
cols = ['cohorts', 'missing', 'extra', 'extra_sq', 'ambig', 'ins', 'unk']
...
def score_window(slw, tlw, weights):
    ...
    score += weights['extra_sq'] * sum([(n-1)*(n-1) for k, n in extra.items() if k in tgt_words])
        ...
        for g in range(args.generations):
            ...
            for i in range(5):
                ...
                procs.append(subprocess.Popen(
                    ['python3', 'round6.py', src, args.target, out,
                     str(i), weight_str],
