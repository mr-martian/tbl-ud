...
cat generated/hbo-grc/grc.conllu | python3 conllu2apertium.py --count 100 --surface NOUN:Gender DET:PronType PROPN:Gender | cg-conv -a | cg-conv -Z --dep-delimit > generated/hbo-grc/grc.gold.bin
